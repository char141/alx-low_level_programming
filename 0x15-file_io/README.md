...
If filename is NULL or the funciton fails - returns -1. Otherwise - returns 1 on success.
...
If the file does not exist or the user lacks write permissions on the file - returns -1. Otherwise - returns 1.
