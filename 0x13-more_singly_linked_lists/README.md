...
Welcome to my low level C programming experience at Holberton School. In this project we will be using linked lists (allocating memory, freeing, setting up dynamically) to complete different tasks.
